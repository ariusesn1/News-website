      ...
      <Row>
        <div>
          <div className="input-group mb-3 mt-3 w-50">
            ...
            <DropdownButton  style={{marginLeft:5}} id="bg-nested-dropdown">
        <Dropdown.Item eventKey="1" onClick={Sorting} >By id</Dropdown.Item>
        <Dropdown.Item eventKey="2" onClick={SortPriceDown} >By price (descend) </Dropdown.Item>
        <Dropdown.Item eventKey="3" onClick={SortPriceUp} >By price (ascend) </Dropdown.Item>
      </DropdownButton>
          </div>
        </div>
        <Posts
